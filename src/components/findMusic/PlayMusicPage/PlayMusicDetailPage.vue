    ...
    <div>
        ...
        <el-row class="topInfo">
            <img :src="music.al.picUrl"
                 style="opacity: 0.4;border-radius: 25px;position: absolute;left:50px;width:1000px;height: 850px;z-index: -1"
                 alt="">
            <el-col :offset="5" :span="6">
                <el-image src="imgs/play-bar.png" style="width: 120px;"></el-image>
                <el-image src="imgs/play-bar-middle.png"
                          style="position: absolute;top: -5px;left: 320px;width: 25px;height: 25px;z-index: 10"></el-image>
        ...
        <!--底部评论信息-->
        <el-main style="margin-top: 220px;margin-bottom: 75px;">
            <el-row>
